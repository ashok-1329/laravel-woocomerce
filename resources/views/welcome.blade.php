...
<div class="container main-container">
    <div class="row">
        <div class="col-md-6 left-section-image">
            <img src="{{ asset('images/verido.jpg') }}" class="img-fluid" alt="Left Image" />
        </div>
        <div class="col-md-6 left-content-main">
            <h2 class="left-content-heading">Oversized Baggy Fit Drop Shoulder Half Sleeves Round Neck Solid Pure</h2>
    ...
    <div class="row">
        <div class="col-md-6 right-section">
            <h2 class="right-content-heading">Walker Leather Office Travel Bag</h2>
        ...
        <div class="col-md-6 right-content-image">
